  ...
  return (
    <div className="relative w-full h-screen flex flex-col items-center justify-center px-4 sm:px-6 mt-15">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <motion.h2
          className="text-3xl sm:text-5xl md:text-6xl font-bold mt-2  text-black"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.p
          className="mt-4 text-lg sm:text-xl  text-slate-800 font-[500]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <div className="relative z-10 bg-black bg-opacity-70 p-4 rounded-lg flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-12 w-full max-w-3xl">
        <input
          ...
          className="p-3 bg-transparent border rounded-md text-white placeholder-gray-400 w-full"
        />
        <input
          type="email"
        ...
        <input
          ...
          className="p-3 bg-transparent border rounded-md text-white placeholder-gray-400 w-full"
        />
        <button className="bg-yellow-500 text-black px-6 py-3 rounded-md w-full sm:w-auto font-semibold">
          Get Started
        </button>
      </div>
      ...
      <div className="relative z-10 flex flex-wrap justify-center items-center gap-4 mt-8 w-full max-w-4xl px-4">
        ...
        <img src={amazon} alt="Amazon Ads Partner" className="h-10 sm:h-12" />
      </div>
